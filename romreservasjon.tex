...
\begin{instruks}{Retningslinjer for reservering av offentlige arealer
    ved Studentersamfundet i Trondhjem}{20. november 2011}{1. mars 2011}
                   ...
                   \item Knaus
                    ...
                    \item Strossa
                        \begin{enumerate}
                            ...
                            \item Lukkete arrangement av eksterne arrangører (utleie)
                        \end{enumerate}
		    \item Trafoen: Andre etasje, stort og lite møterom i UKEår.
			\begin{enumerate}
			    \item Faste møter UKA.
			    \item Andre møter UKA.
			    \item Andre interne møter.		
			\end{enumerate}	
		    \item Trafoen: Andre etasje, stort og lite møterom i ikke UKEår
			\begin{enumerate}
			    \item Interne møter
			\end{enumerate}	

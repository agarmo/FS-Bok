...
\begin{instruks}{Brannvern ved Studentersamfundet i Trondhjem}{20. november 2011}{13. desember 2011}
    ...
    kontrollørkurs med brannopplæring, holdt av Husmann og gjengsjef i LK i samråd. Videre skal gjengsjefer informere sine kollegaer om dette skrivet 
...
\begin{instruksledd}{Vedlegg A: Oversikt over ansvarsfordeling på brannsentralen}
...
\begin{instruksledd}{Vedlegg B: Oversikt over områdeansvarlige på Studentersamfundet.}


   \begin {tabular}{ll}

		Baransvarlig Daglighallen \\
		Baransvarlig Nordre galleri \\
		Baransvarlig Søndre galleri \\
		Barsjef Bodegaen \\
		Barsjef Edgar \\
		Barsjef Klubben \\
		Barsjef Rundhallen \\ 
	...
	\vspace{10mm}
	Disse rapporterer til Husmann eller sikringssjefen ved avvik innenfor
	brannsikkerheten. KSG har i åpningstid en daghavende som følger opp de
	områdeansvarlige i barene

	\vspace{10mm}
	Disse plikter å kjenne sine respektive branninstrukser og rapporterer
	til Husmann eller sikringssjefen ved avvik innenfor brannsikkerheten.
	Ved evakuering skal de områdeansvarlige forholde seg til vakthavende
	og rapportere når lokalet har blitt evakuert. KSG har i åpningstid en
	daghavende som følger opp de områdeansvarlige i barene.
...
\begin{instruks}{Instruks for Funksjonærer}{20. november 2011}{13. desember 2011}
    ...
    \begin{enumerate}
        ...
        \item Personer som har vært aktive funskjonærer i en gjeng, Finansstyrets undergruppe, eller organ i to år kan tildeles
...
\begin{instruks}{Hybelinstruks}{20. november 2011}{13. desember 2011}
...
forekomme etter dette
	    ...
	    \item Hybeldrift skal ikke omtales eller dokumenteres i offentlige fora.
        \end{enumerate}
    \end{instruksledd}
\end{instruks}
...
\begin{instruks}{Instruks for kontrollører}{20. november 2011}{13. desember 2011}
...
strengt knyttet til medlemsskap
        ...
        \item Gjengsjefer plikter å informere nye kontrollører om innholdet i denne
            instruks.
        \item Husmann og gjengsjef i LK plikter i samråd å avholde kontrollørkurs minst en gang i semesteret.
	\item Kontrollører skal bistå områdeansvarlige ved evakuering og må derfor ha god kjennskap til generell brann og brukerinstruks
    \end{enumerate}

\end{instruks}


\begin{instruks}{Instruks for lenkevakter}{16. desember 2010}{1. mars 2011}
